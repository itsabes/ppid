...
// - 0 = TIDAK REVISI
// - 1 = REVISI
// - 2 = SUDAH SELESAI REVISI
// null = DEFAULT
function status_permohonan($status)
{
	switch ($status) {
		case 1:
			return 'Pemeriksaan Berkas Permohonan';

			break;
		case 2:
			return 'Revisi Permohonan';

			break;
		case 3:
			return 'Selesai Revisi Permohonan';

			break;
		case 4:
			return 'Permohonan di Disposisikan';
		...
		case 7:
			...
			break;
		case 8:
			return 'Permohonan telah di berikan Respon Jawaban';

			break;
		case 9:
			return 'Permohonan telah di berikan Respon File Jawaban';
...
function ket_permohonan($keterangan)
{
	switch ($keterangan) {
		case null:
			return '-';
