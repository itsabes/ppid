...
<head>
  ...
  <title><?= namaweb(); ?> | Lupa Password</title>
    ...
    <div id="main_cont" style="margin-top:20px">
      <div class="form-box">
        ...
        <div style="background: #fff;">
          <h3 class="text-center" style="margin: 0;padding: 10px 0"><b>Silahkan masukan email</b></h3>
        </div>
        <?= form_open('lupaPassword', 'id="form-lupa-password"') ?>
        ...
        <div class="footer">
          <button type="submit" name="submit" id="submit" class="btn bg-blue btn-block">Kirim Email</button>
